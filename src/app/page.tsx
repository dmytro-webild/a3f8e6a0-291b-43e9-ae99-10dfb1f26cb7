...
export default function LandingPage() {
  ...
  <div id="pricing" data-section="pricing">
      ...
      useInvertedBackground={false}
      plans={[
        { id: "cut", badge: "Populair", price: "€35", subtitle: "Precisie Knippen", features: ["Consultatie", "Gedetailleerde Knipbeurt", "Styling Finish"] },
        { id: "beard", badge: "Extra", price: "€25", subtitle: "Baard Styling", features: ["Hot Towel", "Strakke Lijnen", "Conditioning"] },
        { id: "combo", badge: "Beste Waarde", price: "€55", subtitle: "De Volledige Behandeling", features: ["Precisie Knipbeurt", "Baard Styling", "Styling Advies"] },
      ]}
  ...
  <div id="testimonial" data-section="testimonial">
      ...
      useInvertedBackground={false}
      testimonials={[
        { id: "1", name: "Markus", date: "Jan 2025", title: "Professional", quote: "Altijd consistente precisie. Ik ben eindelijk klaar met zoeken naar een goede kapper.", tag: "Regelmatig", avatarSrc: "http://img.b2bpic.net/free-photo/i-owe-my-appearance-daily-hygiene_329181-4760.jpg" },
        ...
        { id: "3", name: "David", date: "Nov 2024", title: "Vader", quote: "Vriendelijk voor mijn kinderen, stressvrije omgeving. Een aanrader voor gezinnen.", tag: "Vader", avatarSrc: "http://img.b2bpic.net/free-photo/hairdresser-straighten-beard-with-razor-hairbrush-senior-client_23-2148181919.jpg" },
        { id: "4", name: "Peter", date: "Oct 2024", title: "Ondernemer", quote: "Vakmanschap op zijn best. Eerlijke service en altijd constant.", tag: "Loyal", avatarSrc: "http://img.b2bpic.net/free-photo/handsome-fashion-businessman-model-dressed-elegant-blue-suit-posing-street_158538-14362.jpg" },
        { id: "5", name: "Thomas", date: "Sep 2024", title: "Professional", quote: "Niet wachten, geen gedoe. Gewoon een strakke coupe elke keer weer.", tag: "Regelmatig", avatarSrc: "http://img.b2bpic.net/free-photo/side-view-senior-man-laughing_23-2151203948.jpg" },
      ]}
  ...
  <div id="footer" data-section="footer">
      <FooterBase
      columns={[
        { title: "Menu", items: [{ label: "Diensten", href: "#features" }, { label: "Prijzen", href: "#pricing" }, { label: "Team", href: "#team" }] },
